...
| `src/treg/application/call/serpstat.py` | architecture/money.md |
...
| `src/treg/catalog/apify.yaml` | architecture/catalog.md, architecture/money.md |
...
| `src/treg/catalog/companyenrich.yaml` | architecture/catalog.md, architecture/money.md |
...
| `src/treg/catalog/lusha.yaml` | architecture/catalog.md |
...
| `src/treg/catalog/seranking.yaml` | architecture/money.md |
| `src/treg/catalog/serpstat.yaml` | architecture/money.md |
...
| `src/treg/domain/feedback.py` | architecture/feedback.md, architecture/import-boundaries.md |
